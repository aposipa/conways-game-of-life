      ...
      <div className="game-display">
        <div className="left-side">
          ...
          <div className="buttons">
            ...
            <form className="time-interval" onSubmit={handleSubmit}>
              <label>
                Time Interval:
                <input value={time} type="number" onChange={handleTimeChange} />
                msec
              </label>
            </form>
          </div>
        ...
        <div className="game-text">
          ...
          <p>
            ...
            move around the "landscape". Note: cells that are off the edge of
            the grid are typically assumed to be dead.{" "}
          </p>
          <h2>Interactive Rules:</h2>
          <ul>
            <li>
              You can customize the grid to your liking while the game is{" "}
              <u>
                <b>not</b>
              </u>{" "}
              running. Simply click on a square to make it alive, or dead.
            </li>
            <li>
              The 'Randomize Grid' button will generate a random grid to start
              with.
            </li>
            <li>
              The 'Next Generation' button will manually progress the game one
              generation at a time.
            </li>
            <li>
              You can set the runtime of the game via the 'Time Interval' by
              inputing your own time. Time is in milliseconds(1000 msec = 1
              sec).
            </li>
          </ul>
        </div>
        <footer className="alg-text">
          ...
          <p>
            ...
            cellular automaton) is said to be Turing-complete or computationally
            universal if it can be used to simulate any Turing machine. This
            means that this system is able to recognize or decide other
            data-manipulation rule sets. Turing completeness is used as a way to
            express the power of such a data-manipulation rule set. Virtually
            all programming languages today are Turing-complete. The concept is
            named after English mathematician and computer scientist Alan
            Turing.
          </p>
        </footer>
      </div>
